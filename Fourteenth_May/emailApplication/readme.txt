To run email application you need to add jars that is given in the folder and need to use RestFul Api's that are mailtrap and weatherapi.

Here is the links for mailtrap and weatherapi :
...
By following these steps you can be able to run the mail application.
